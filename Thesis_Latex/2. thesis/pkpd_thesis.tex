...
\captionsetup[table]{font={sf,footnotesize}, position=above}
...
\noindent\textbf{Keywords:} drug discovery, PK-PD, Neural ODE, multi-task learning, graph neural networks, calibration
...
\noindent\textbf{Słowa kluczowe:} odkrywanie leków, PK-PD, Neural ODE, uczenie wielozadaniowe, grafowe sieci neuronowe, kalibracja
