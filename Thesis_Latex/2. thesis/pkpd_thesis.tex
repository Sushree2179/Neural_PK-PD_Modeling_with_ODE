...
\section{Interpretability and Exploratory Extensions}

Additional interpretability experiments, including feature attribution, atom-level GNN saliency, and latent-space visualization, were used to identify the molecular features driving the final predictions. These analyses support the plausibility of the learned representations by highlighting chemically meaningful regions associated with binding and safety. They provide useful supporting evidence, but they are not the primary basis of the thesis claims and are therefore treated as secondary result material.
