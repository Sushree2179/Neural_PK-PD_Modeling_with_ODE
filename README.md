...
**Integrating Mechanistic Priors with Physics-Informed Neural ODEs**

Last Updated: 22 Mar 2026

---

## [PROJECT SUMMARY - Complete Project Navigation](Documentation/PROJECT_SUMMARY.md)

Everything you need - status, metrics, notebook guide, design decisions, and next steps - lives in one document.
...
| RapidDock Prototype Notebook | [Coding/rapid_dock_transformer_demo.ipynb](Coding/rapid_dock_transformer_demo.ipynb) |
